                    ...
                    {paginated.map(notification => {
                        ...
                        return (
                            <div
                                ...
                                className={`bg-card border-border border rounded-xl p-4 transition-all group cursor-pointer hover:shadow-md ${
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-6 bg-card border-border border rounded-xl p-3">
                    ...
                    <div className="flex items-center gap-1">
                        <button
                            ...
                            className="px-3 py-1.5 text-sm rounded-lg transition-colors disabled:opacity-40 hover:bg-secondary/60 text-foreground"
                        >
                            ← Prev
                        </button>
