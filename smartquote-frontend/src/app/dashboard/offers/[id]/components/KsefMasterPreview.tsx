            ...
            <div className="w-full max-w-3xl max-h-[90vh] overflow-y-auto bg-card border-border rounded-xl shadow-2xl">
                <div className="sticky top-0 z-10 bg-card border-border border-b border-border px-6 py-4 flex items-center justify-between rounded-t-xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 id="ksef-preview-title" className="text-lg font-semibold text-foreground">
                    ...
                    <button
                        onClick={onClose}
                        className="p-2 text-muted-foreground hover:text-foreground hover:bg-secondary/60 rounded-lg transition-colors"
                    >
                ...
                <div className="p-6 space-y-6">
                    ...
                    {previewError && (
                        <div className="rounded-lg bg-destructive/100/10 border border-red-500/25 p-4 text-center">
                            ...
                            <button
                                onClick={loadPreview}
                                className="mt-2 text-xs text-status-rejected underline hover:no-underline"
                            >
                                Spróbuj ponownie
                            </button>
                        </div>
                        ...
                        <>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="rounded-2xl border border-border bg-card p-4 shadow-card">
                                    ...
                                    <p className="text-sm text-muted-foreground">NIP: {preview.seller.nip}</p>
                                ...
                                <div className="rounded-2xl border border-border bg-card p-4 shadow-card">
                                    ...
                                    <p className="text-sm text-muted-foreground">NIP: {preview.buyer.nip}</p>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 rounded-lg border border-border bg-card text-foreground text-foreground text-sm"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-foreground mb-1">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-sm">
                                        ...
                                        <tr className="border-b border-border">
                                            <th className="text-left py-2 pr-4 text-muted-foreground font-medium">Nazwa</th>
                                            <th className="text-right py-2 px-2 text-muted-foreground font-medium">Ilość</th>
                                            <th className="text-right py-2 px-2 text-muted-foreground font-medium">Cena netto</th>
                                            <th className="text-right py-2 px-2 text-muted-foreground font-medium">VAT</th>
                                            <th className="text-right py-2 pl-2 text-muted-foreground font-medium">Brutto</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div className="mt-4 pt-3 border-t border-border flex justify-end">
                                    <div className="w-56 space-y-1.5">
                                        ...
                                        <div className="flex justify-between text-base font-semibold pt-1.5 border-t border-border">
                                            ...
                                            <span className="text-[oklch(0.55_0.14_60)]">
                            ...
                            <div className="rounded-lg bg-[oklch(0.72_0.16_60)/10%]0/10 border border-amber-500/25 p-4">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-[oklch(0.55_0.14_60)] dark:text-[oklch(0.78_0.14_60)] dark:text-amber-300">
                                            Dane zostaną przesłane do poczekalni KSeF Master
                                        </p>
                                        <p className="text-xs text-[oklch(0.55_0.14_60)] dark:text-[oklch(0.78_0.14_60)]/80 dark:text-amber-400/80 mt-1">
