            ...
            <div className="rounded-2xl border border-status-accepted/25 overflow-hidden">
                ...
                <div className="p-5 bg-card border-border space-y-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-center">
                            <span className="text-xs text-muted-foreground">Data akceptacji</span>
                ...
                {formatDateTime(auditLog.acceptedAt)}
                  ...
                  {auditLog.selectedVariant}
                        ...
                        <div className="flex justify-between items-center">
                            <span className="text-xs text-muted-foreground">Kwota brutto</span>
                ...
                {formatCurrency(Number(auditLog.totalGross))} {auditLog.currency}
                        ...
                        <div className="pt-3 border-t border-border">
                            <div className="flex items-center justify-between mb-1.5">
                                <span className="text-xs text-muted-foreground">Content Hash (SHA-256)</span>
                                <button
                ...
                <div className="p-4 bg-[oklch(0.72_0.16_60)/10%] dark:bg-amber-950/30">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[oklch(0.55_0.14_60)] mt-0.5">
