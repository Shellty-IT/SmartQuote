                ...
                <div className="flex items-start justify-between gap-4">
                    ...
                    {currentStep === 'items' && (
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-cyan-500/40 bg-cyan-500/10 text-primary text-sm font-medium hover:bg-primary/15 transition-colors shrink-0"
                        >
