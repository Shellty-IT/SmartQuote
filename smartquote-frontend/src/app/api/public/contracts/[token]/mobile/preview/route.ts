// src/app/api/public/contracts/[token]/mobile/preview/route.ts
// Public (no auth) HTML preview for "Aplikacja mobilna" contract template.
...
export async function GET(
    ...
    const html = buildHtmlPreviewOrRespond('public-contract-mobile-preview', () =>
        applyPdfPreviewMode(addDocumentActionLinks(buildContractMobileHtmlFromSaved(contract.blocks, { editorMode: false }), `/contract/view/${token}#sign`, 'sign')),
    )
