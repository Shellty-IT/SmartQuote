// src/app/api/public/contracts/[token]/short/preview/route.ts
// Public (no auth) HTML preview for "Umowa — Krótka" short contract template.
...
export async function GET(
    ...
    const html = buildHtmlPreviewOrRespond('public-contract-short-preview', () =>
        applyPdfPreviewMode(addDocumentActionLinks(buildContractShortHtmlFromSaved(contract.blocks, { editorMode: false }), `/contract/view/${token}#sign`, 'sign')),
    )
