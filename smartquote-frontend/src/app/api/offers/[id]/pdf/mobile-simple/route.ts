...
export async function GET(
    ...
    let html: string
    try {
        html = addDocumentActionLinks(buildMobileSimpleHtml(blocks, offerData), publicDocumentUrl('offer', (offer as RawOfferData & { publicToken?: string }).publicToken, 'accept'), 'accept')
    } catch (err) {
