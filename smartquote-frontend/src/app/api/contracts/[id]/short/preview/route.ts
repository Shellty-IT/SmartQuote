// src/app/api/contracts/[id]/short/preview/route.ts
// Returns raw HTML for the "Umowa — Krótka" template — used for in-browser preview (iframe).
// GET /api/contracts/:id/short/preview  →  text/html
...
export async function GET(
    ...
    const html = buildHtmlOrRespond('contract-short-preview', () =>
        applyPdfPreviewMode(buildContractShortHtmlFromSaved(contract.blocks, { editorMode: false })),
    )
