...
export default function RejectDialog({
    ...
    const tr = useTranslations('offerPublic').rejectDialog;
                ...
                <div className="p-6">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0">
                            <svg className="w-6 h-6 text-status-rejected" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-slate-700 mb-2">
                            {tr.reasonLabel}
                            <span className="text-slate-400 font-normal"> {tr.reasonOptional}</span>
                        </label>
                        <textarea
                            value={reason}
