...
export function ServicesSectionManagerPanel({
    ...
    const togglePageBreakAfter = (key: ContractServicesPageBreakKey) => {
        onSave({
            ...blocks,
    ...
    const removeSection = (key: ContractServicesSectionKey) => {
        ...
        onSave({ ...blocks, [key]: { ...raw, enabled: false }, sections: next, pageBreakAfter: pageBreakAfter.filter((k) => k !== key) })
    }
