            ...
            <div className="flex flex-wrap gap-2">
                {suggestions.map((suggestion) => (
                    <button
                        ...
                        className="text-xs px-3 py-1.5 bg-surface-subtle text-muted-foreground rounded-full hover:bg-secondary/60 transition-colors"
                    >
                        {suggestion}
                    </button>
                ))}
...
function TypingIndicator() {
    return (
        <div className="flex items-start gap-3">
            ...
            <div className="bg-surface-subtle rounded-2xl rounded-tl-none px-4 py-3">
                <div className="flex items-center gap-1">
                    <span
                        className="w-2 h-2 bg-primary/100 rounded-full animate-bounce"
