            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={toggleOpen}
                        className="fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center justify-center w-14 h-14 bg-gradient-to-r bg-gradient-primary rounded-full shadow-lg shadow-cyan-500/25 hover:shadow-xl hover:shadow-cyan-500/30 transition-shadow"
                    >
