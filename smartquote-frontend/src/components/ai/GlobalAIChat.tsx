            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={toggleOpen}
                        className="fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center justify-center w-14 h-14 bg-gradient-primary rounded-full shadow-glow ring-1 ring-white/15 hover:brightness-110 transition-shadow"
                    >
